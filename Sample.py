...
class Widget12: #GUI OF VIRTUAL ASSISTAND AND COMMANDS
    def _init_(self):
        root = Tk()
        root.title('lena')
        ...
        top = Message(userFrame, textvariable=userText, bg='black',fg='white'),top.config(font=("Century Gothic", 15, 'bold'))
